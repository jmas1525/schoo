...
public class Day {
	...
	public int lapsedDays() {
		...
		GregorianCalendar NewYearDay = new GregorianCalendar(year, 1, 1);
	...
	public int daysLeft() {
		GregorianCalendar today = toGregorianCalendar();
		GregorianCalendar YearEndDay = new GregorianCalendar(year, 12, 31);
		int lapsed = (int)((YearEndDay.getTimeInMillis() - today.getTimeInMillis()) / (1000 * 60 * 60 * 24) );
		return lapsed;
	}
